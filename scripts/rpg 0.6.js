...
function JogarMoeda() {
  ...
  document.getElementById("btnCaraCoroa").style.display = "none";
}
...
function Pushname1() {
  ...
  document.querySelector("#Player1").innerHTML =
    "Agora escolha seu herói " + localStorage.getItem("P1");
}
...
function P2Mag() {
  ...
  document.querySelector("#VerEscolhas").innerHTML =
    ...
    " escolheu " +
    localStorage.getItem("Heroi2");
  document.getElementById("meioTela2").style.display = "none";
}
function P2Cav() {
  prompt("Voce escolheu cavaleiro");
...
function AtaqueP1() {
  ...
  document.querySelector("#AtkP1").innerHTML = "";
  document.querySelector("#status").innerHTML =
    "Muito bem, agora escolha uma carta " + escolhaP1;
...
function AtaqueP2() {
  ...
  document.querySelector("#status").innerHTML =
    "Muito bem, agora escolha uma carta " + escolhaP2;
